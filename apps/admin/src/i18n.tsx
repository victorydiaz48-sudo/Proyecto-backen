...
const pt = {
  ...
  business: 'Negócio',
  businessHint: 'O identificador do link da sua página (ex.: barbearia-alpha-clube) ou o nome do negócio.',
  email: 'E-mail',
  password: 'Senha',
  login: 'Entrar',
  logout: 'Sair',
  invalidCredentials: 'E-mail, senha ou negócio incorretos.',
  tooManyAttempts: 'Muitas tentativas. Espere alguns minutos e tente de novo.',
  originRejected: 'O navegador bloqueou o envio por segurança. Recarregue a página e tente de novo.',
  // nav
  navAgenda: 'Agenda',
...
const es: Dict = {
  ...
  business: 'Negocio',
  businessHint: 'El identificador del enlace de tu página (p. ej. barbearia-alpha-clube) o el nombre del negocio.',
  email: 'Email',
  password: 'Contraseña',
  login: 'Entrar',
  logout: 'Salir',
  ...
  originRejected: 'El navegador bloqueó el envío por seguridad. Recarga la página y vuelve a probar.',
  navAgenda: 'Agenda',
